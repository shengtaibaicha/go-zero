...
import (
	...
	adminServer "go-zero/apps/rpc/user/internal/server/admin"
	userServer "go-zero/apps/rpc/user/internal/server/user"
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		...
		user.RegisterAdminServer(grpcServer, adminServer.NewAdminServer(ctx))
