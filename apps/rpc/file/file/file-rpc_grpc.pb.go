...
const (
	...
	File_AuditFile_FullMethodName      = "/file.File/AuditFile"
)
...
func (c *fileClient) AuditFile(ctx context.Context, in *AuditFileReq, opts ...grpc.CallOption) (*AuditFileResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuditFileResp)
	err := c.cc.Invoke(ctx, File_AuditFile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FileServer interface {
	...
	AuditFile(context.Context, *AuditFileReq) (*AuditFileResp, error)
...
func (UnimplementedFileServer) AuditFile(context.Context, *AuditFileReq) (*AuditFileResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AuditFile not implemented")
}
...
func _File_AuditFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AuditFileReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FileServer).AuditFile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: File_AuditFile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServer).AuditFile(ctx, req.(*AuditFileReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var File_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AuditFile",
			Handler:    _File_AuditFile_Handler,
		},
	},
